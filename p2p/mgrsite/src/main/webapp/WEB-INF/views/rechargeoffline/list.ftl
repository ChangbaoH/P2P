					    ...
					    <select class="form-control" name="bankInfoId">
					    	...
					    	<#list banks as bank>
	    						<option value="${bank.id}">
									<script>
										var str="("+SITE_BANK_TYPE_NAME_MAP["${bank.id}"]+")${bank.accountNumber}${bank.bankForkName}";
										document.write(str);
									</script>
								</option>
	    					</#list>
					...
					<table class="table">
						...
						<#list pageResult.listData as info>
							<tr>
								...
								<td>
									<script>
										var str="("+SITE_BANK_TYPE_NAME_MAP["${info.bankInfo.id}"]+")${info.bankInfo.accountNumber}${info.bankInfo.bankForkName}";
										document.write(str);
									</script>
								</td>
