...
import com.hcb.p2p.business.domain.*;
import com.hcb.p2p.business.mapper.*;
import com.hcb.p2p.business.query.BidRequestQueryObject;
import com.hcb.p2p.business.query.PaymentScheduleQueryObject;
import com.hcb.p2p.business.service.IAccountFlowService;
import com.hcb.p2p.business.service.IBidRequestService;
import com.hcb.p2p.business.service.ISystemAccountService;
import com.hcb.p2p.business.util.CalculatetUtil;
import com.hcb.p2p.business.util.DecimalFormatUtil;
	...
	public void fullAudit2(Long id, String remark, int state) {
		...
		if (br != null
			...
			if (state == BidRequestAuditHistory.STATE_AUDIT) {
				...
				//修改验证码
				borrowAccount.setVerifyCode(MD5.encode(borrowAccount.getUsableAmount().hashCode() + " "
						+ borrowAccount.getFreezedAmount().hashCode()));
